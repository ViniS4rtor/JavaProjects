...
public class colisaoCarros {
    public static void main(String[] args) {
        ...
        double cineticaLiberada, cineticaInicial, cineticaFinal, deformacao, aceleracaoMediaMs, aceleracaoMediaKm, forcaG;
        ...
        velocidadePrimeiro = Double.parseDouble(JOptionPane.showInputDialog("Insira a velocidade em Km/h do 1° carro: "));
        velocidadeSegundo = Double.parseDouble(JOptionPane.showInputDialog("Insira a velocidade em Km/h do 2° carro: "));
        ...
        JOptionPane.showMessageDialog(null, "A velocidade final após a colisão é de: " + df.format(velocidadeFinal) + " m/s");
        ...
        JOptionPane.showMessageDialog(null, "A energia cinética inicial é de: " + df.format(cineticaInicial) + " J");
        ...
        JOptionPane.showMessageDialog(null, "A energia cinética liberada é de: " + df.format(cineticaLiberada) + " J");

        // Entrada da deformação com validação

        while (true) {
            try {
                deformacao = Double.parseDouble(JOptionPane.showInputDialog("Insira a distância da deformação dos corpos durante a colisão (em metros, entre 0.5 e 1.0): "));
            if (deformacao >= 0.5 && deformacao <= 1.0) {
                break; // Sai do loop se o valor for válido
            } else {
            JOptionPane.showMessageDialog(null, "Valor inválido! A deformação deve estar entre 0.5 e 1.0 metros.");
         }
        ...
        JOptionPane.showMessageDialog(null, "A aceleração média (km/h) durante o impacto foi de: " + df.format(aceleracaoMediaKm));
        ...
        if (forcaG < 1) {
            ...
            JOptionPane.showMessageDialog(null, "A pessoa provavelmente não sobreviveu, com sorte pode sobreviver.");
        } else if (forcaG > 5 && forcaG < 7) {
            JOptionPane.showMessageDialog(null, "A pessoa provavelmente não sobreviveu, com sorte da para enterra-la .");
        } else if (forcaG > 7 && forcaG < 10) {
            JOptionPane.showMessageDialog(null, "Tenha certeza que morreu, se der para cremar é lucro.");
        } else {
            JOptionPane.showMessageDialog(null, "A pessoa foi completamente evaporado e obliterado da terra, aniquilado completamente, se o carro estiver minimamente reconhecivel você estará muitooo no lucro. ");
        }
    


        int resposta = JOptionPane.showConfirmDialog(null, "Deseja recaucular o valor?","Continuar", JOptionPane.YES_NO_OPTION);
