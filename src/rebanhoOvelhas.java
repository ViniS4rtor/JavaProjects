    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Para estudo genético (Negras) Quantia: " + negra + ("\n Valor em dinheiro: R$" + valorNegras));
            JOptionPane.showMessageDialog(null,
                    "Para venda (Marrons) Quantia: " + marrom + ("\n Valor em dinheiro: R$" + valorMarrons));
            JOptionPane.showMessageDialog(null,
                    "Para avaliação (Outras cores) Quantia: " + outraCor + ("\n Valor em dinheiro: R$" + valorOutra));

            // Total de ovelhas
            JOptionPane.showMessageDialog(null,
                    "A quantia total das ovelhas é de: " + (branca + marrom + negra + outraCor));

            // Valor de todas as Ovelhas
            JOptionPane.showMessageDialog(null, "O valor total em dinheiro das ovelhas é de: R$"
                    + (valorBrancas + valorMarrons + valorNegras + valorOutra));

            int resposta = JOptionPane.showConfirmDialog(null, "Deseja fazer a recontagem?", "Continuar",
